...
import 'package:futcrick/Pages/matches/TeamDetails.dart';
...
class _MatchCardState extends State<MatchCard> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      highlightColor: widget.isClickable ? Colors.white24 : Colors.transparent,
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: widget.isLive ? Colors.white54 : Colors.transparent,
                    offset: Offset(1, 1),
                    blurRadius: 10)
              ],
